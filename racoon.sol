...
RACOON the smartest Memecoin Doge Killers and Reflect (RFI) Treasury.  
RACOON incorporates community adjustable yield rates. 
RACOON also has a deflationary supply, adjustable burn fee. 
and fair-launch mechanisms to ensure a healthy distribution of tokens. 
The initial website is racoon.surge.sh
 */
...
contract RACOON is Context, IBIP20, Ownable {
    ...
    string private _name = 'racoon.surge.sh';
